			...
			if (mat < 14) {
				if (mat < 8) {
					if (mat < 5) {
						...
						if (mat == 3) return vec4(vec3(1.0, 1.0, 1.0) * 4.0, 0.0); // End Rod
			...
			if (mat < 38) {
				...
				if (mat < 44) {
					if (mat < 41) {
						...
						if (mat == 43) return vec4(vec3(1.8, 1.0, 0.5) * 0.5, 0.06) * GLOWING_ORE_MULT; // Iron Ores
					}
				} else {
					if (mat < 47) {
						...
						if (mat == 48) return vec4(vec3(0.4, 2.2, 2.5) * 0.5, 0.18) * GLOWING_ORE_MULT; // Diamond Ores
